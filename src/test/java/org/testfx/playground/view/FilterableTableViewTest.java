...
public class FilterableTableViewTest extends ApplicationTest {
	...
	public void start(Stage stage) throws Exception {
		...
		FilterableTableView<Item> filterableTable = new FilterableTableView<>(tableView, new TextField());
	...
	public void testFilter() {
		...
		TableView<Item> tableView = lookup(".table-view").queryTableView();
		TextInputControl textField = lookup(".text-field").queryTextInputControl();
		...
		// remove filter
		push(new KeyCodeCombination(KeyCode.A, KeyCombination.SHORTCUT_DOWN));
